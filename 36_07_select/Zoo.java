...
public class Zoo {
 ...
 "ORDER BY ANIMALS.id desc limit 1;";
    ...
    public List<Animal> recuperaAnimals() throws SQLException {
        ...
        String sql = "SELECT animals.nom as ani_nom,animals.id as id_ani,categories.nom as cat_nom FROM ANIMALS, CATEGORIES WHERE animals.categoria=categories.id ORDER BY animals.id desc;";
